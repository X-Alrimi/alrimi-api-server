...
object NewsFactory {
    ...
    val similarityValues = listOf(-2.4610e-01, 2.4282e-01, 2.5895e-01, 1.3177e+00, -1.1293e-01,
            ...
            1.2562e-02, 7.4288e-01, -1.6359e-01, 4.6118e-01)

    fun getAlarmNewsDto(): AlarmNewsDto {
        return AlarmNewsDto("YG", getNewsDto())
    }
    ...
    fun getCriticalNewsDto(): CriticalNewsDto {
        return CriticalNewsDto(getAlarmNewsDto(), true, similarityValues)
    }
